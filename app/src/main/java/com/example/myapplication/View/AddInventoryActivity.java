...
public class AddInventoryActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_ID = "package com.example.myapplication.View.EXTRA_ID";
    public static final String EXTRA_NAME = "package com.example.myapplication.View.EXTRA_NAME";
    public static final String EXTRA_PRICE = "package com.example.myapplication.View.EXTRA_PRICE";
    public static final String EXTRA_QUANTITY = "package com.example.myapplication.View.EXTRA_QUANTITY";
    public static final String EXTRA_MANUFACTURE = "package com.example.myapplication.View.EXTRA_MANUFACTURE";
    public static final String EXTRA_IMAGE = "package com.example.myapplication.View.EXTRA_IMAGE";
